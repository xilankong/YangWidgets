...
open class YangGuidePageView: UIView {
...
open class YangGuidePageViewController: UIViewController {
    ...
    public var guidPages: [YangGuidePageView] = []
...
//MARK: - 事件
extension YangGuidePageViewController: UIScrollViewDelegate, YangPageControlDelegate {
